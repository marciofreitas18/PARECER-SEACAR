...
function gerarParecerSEACAR(dados) {
    ...
    const percentualRSC = dados.percentualRsc || mapaPercentuaisIQ[nivel] || '';
    ...
    <body>
        ...
        <p class="sem-recuo" style="margin-left: 0.5cm;">
            <strong>${checkDeferido} OPINA-SE PELO DEFERIMENTO</strong> do pedido, sugerindo-se o encaminhamento dos autos ao Pró-Reitor de Gestão de Pessoas para emissão da respectiva Portaria de concessão do <strong>${nivel}${textoPercentual}</strong>, com efeitos financeiros a contar de <strong>${dataVigencia}</strong>.<br><br>
